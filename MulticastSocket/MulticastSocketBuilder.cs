...
namespace Ubicomp.Utils.NET.Sockets
{
    ...
    public class MulticastSocketBuilder
    {
        ...
        public MulticastSocket Build()
        {
            ...
            {
                _logger?.LogWarning("MulticastSocket is binding to Wildcard (0.0.0.0). This may leak traffic to all interfaces. Use WithInterface() or configure MulticastSocketOptions.LocalNetwork(...) to restrict.");
            }
